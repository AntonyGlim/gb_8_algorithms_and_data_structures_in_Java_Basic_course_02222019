...
public class MyArrayListAddingTest {
    ...
    public MyArrayListAddingTest(char[] symbolsBefore, int arrSize, int elementIndex1, int elementIndex2, int elementIndex3, char[] symbolsAfter) {
